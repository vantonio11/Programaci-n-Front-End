    ...
    <>
      ...
      >
        {isOpen ? (
          ...
          // Ícono de accesibilidad cuando el menú está cerrado
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            <circle cx="12" cy="5" r="2"></circle>
            <path d="M12 9c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3m0 6c-1.657 0-3 1.343-3 3v4h2v-4c0-.552.448-1 1-1s1 .448 1 1v4h2v-4c0-1.657-1.343-3-3-3m9-7h-6v2h4l-5.5 9.5h-3.5l5.5-9.5v-2h-6v2h4l-4 7h-2l4-7v-2h-5v11h2v-9h3l2 3h-5v2h7l-1.5 2.5h2.5l1.5-2.5h2.5l-1.5-2.5h2.5l1.5 2.5v9h2v-11z"></path>
          </svg>
        )}
      </button>
